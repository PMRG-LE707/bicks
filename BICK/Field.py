...
class TotalFieldInPhcS:
    """
    The field profile in PhC slab when the fields and
    corresponding coefficients are provided.
    """
    def __init__(self, fields, coefs):
        """Initialize the total fields in PhC
        
        Paramters
        ---------
        fields: list, type=FieldInPhcS
            the cosidered fields.
        coefs: list, type=float
            the corresponding coefficients of fields.
        """
        self.fields = fields
        self.coefs = coefs
